...
// Mock employee data - in real app, this would be fetched from route state or API
const MOCK_EMPLOYEE = {
  id: 'EMP-001',
  name: 'Ramesh Kumar',
  ...
  permanentAddress: '123 Village Road, Bihar',
  localAddress: '45 Worker Colony, Bangalore',
  role: 'DW',
...
export function EditEmployeeScreen() {
  ...
  const employee = MOCK_EMPLOYEE; // In real app, fetch from API using id
  ...
  const handleRoleChange = (roleCode: string) => {
    ...
    setFormData({
      ...formData,
      role: roleCode,
      category: selectedRole?.category || formData.category,
    });
  };
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-1">Update employee details - {employee.id}</p>
        </div>
